  ...
  return (
    <div className="home-body-container">
      <div className="container-display">
        <Helmet title={"Mantequilla"} htmlAttributes={{ lang: "en" }} />
        {/* Section no.1 */}
        <div className="front-page-container_global">
          <div className="front-page-container-principal">
            <div className="primary-container-presentation">
              <p>{frontPageArt.section}</p>
              <p>{frontPageArt.title}</p>
              <p>
                Esta es la descripción de eeste articulo, y este corresponde a
                la descripción quer ste tendra jajajaja
              </p>
              <p>Por Rafael Barrientos</p>
              <p>2022-12-28</p>
            </div>
            <div className="front-page-image-principal">
              <img
                src={frontPageArt.cover}
                alt="cover"
                className="front-page-image_principal"
              />
            </div>
          </div>
          <div className="frot-page-container-secondary">
            <div className="subcontainer-presentation-secondary">
              <p>portada secundaria</p>
            </div>
            <div className="subcontainer-presentation-secondary">
              <p>portada tercera</p>
            </div>
              ...
              >
                <div className="article" key={article.articleID}>
                  ...
                  <div className="text-container">
                    ...
                    <p className="type-article text-mod">
        ...
        <div className="dont-miss-container">
          <img
            className="dont-miss-img"
            src={drinksFoodArt.cover}
            alt="cover"
          />
          <div className="dont-miss-article-container">
